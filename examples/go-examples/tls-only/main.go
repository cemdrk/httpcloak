...
func main() {
	...
	tlsOnlySession := httpcloak.NewSession("chrome-143", httpcloak.WithTLSOnly())
	...
	apiSession := httpcloak.NewSession("chrome-143", httpcloak.WithTLSOnly())
	...
	normalSession := httpcloak.NewSession("chrome-143")
	...
	tlsOnlySession2 := httpcloak.NewSession("chrome-143", httpcloak.WithTLSOnly())
